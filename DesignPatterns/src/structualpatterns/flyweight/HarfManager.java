 ...
 */
package structualpatterns.flyweight;
...
public class HarfManager {
    ...
    /*
     * Doküman satirlarinin ve satirlarda kullanilan harf pozisyonlarinin
     * tutuldugu iki boyutlu array.
     */
    ...
    /*
     * Bir harf nesnesi olusturur. Mevcut harf nesneleri harfList degiskeninde
     * tutulur. Bu listede yeralmayan harfler new ile olusturularak listeye
     * dahil edilirler.
     *     
* @param h Harf
        ...
        for (int x = 0; x < 50; x++) {
            for (int y = 0; y < 50; y++) {
                if (manager.document[x][y] != null) {
                    System.out.print((manager.document[x][y])
                            .getHarf());
                } else {
                    break;
                }
